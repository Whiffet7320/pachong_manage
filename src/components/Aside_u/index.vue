  ...
  <div class="aside">
    ...
    <div class="menu">
      ...
      <el-menu
        ...
        text-color="#fff"
        active-text-color="#006DD0"
        router
      >
        <template v-if="true">
          <el-menu-item v-if="isHaveSY" :route="{ name: 'Shouye_u' }" index="1-1">
          ...
          >
           ...
           <el-menu-item v-if="isHaveWZ" :route="{ name: 'Fabuliebiao_u' }" index="82-1">
        ...
        <template v-if="false">
          ...
          <el-menu-item :route="{ name: 'Fabuliebiao_u' }" index="82-1">
            <i class="el-icon-s-opportunity"></i>
            <span slot="title">温州教育</span>
          </el-menu-item>
          <!-- <el-submenu index="82">
...
export default {
  ...
  watch: {
    ...
    $route(to) {
      ...
      } else if (to.path == "/Caiji_u/Redulianjie_u") {
        this.menuActiveIndex = "80-1";
      } else if (to.path == "/Caiji_u/Yuntureci_u") {
        this.menuActiveIndex = "80-2";
      } else if (to.path == "/Caiji_u/FabuXinwen_u") {
        this.menuActiveIndex = "80-3-1";
      ...
      } else if (to.path == "/Wenzhoujiaoyu_u/Fabuliebiao_u") {
  ...
  created() {
    ...
    if (this.menu[this.menu.length-1].name == "温州教育") {
      console.log(this.menu.length)
      this.isHaveWZ = true;
      this.menu.pop();
    } else {
