            ...
            <el-row>
              <el-col :span="20">
                <el-form-item label="分类" prop="category_name">
                  <el-select @change='changeFenlei' size='small' v-model="addForm.id" filterable placeholder="请选择">
                    <el-option
                      v-for="item in fenleiOptions"
                      :key="item.id"
                      :label="item.name"
            ...
            <el-row>
              <el-col :span="20">
                <el-form-item label="商品" prop="category_name">
                  <el-select :disabled='!haveFenlei' size='small' v-model="addForm.shop_id" filterable multiple placeholder="请选择">
                    <el-option
...
export default {
  ...
  methods: {
    async getData() {
      const res = await this.$api.getShopByCategory({
